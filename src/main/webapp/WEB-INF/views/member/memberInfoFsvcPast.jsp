	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-7" id="">
				<div class="box_mi">
					<span class="h2_font">위탁 서비스 - 누적 펫시팅 이력</span>
					<div class="box_white">
						...
						<div style="text-align:center">
							<nav aria-label="Page navigation example"style=" display: inline-block;">
								<c:if test="${count>5 }">
									<ul class="pagination ">
										<c:if test="${page>1}">
											<li class="page-item"><a class="page-link" href="memberInfoFsvcPast?page=${page-1}" style="color:gray">Previous</a></li>
										</c:if>

										<c:if test="${count>page*5 }">
											<li class="page-item"><a class="page-link" href="memberInfoFsvcPast?page=${page+1}" style="color:gray">Next</a></li>
										</c:if>
									</ul>
								</c:if>
							</nav>
