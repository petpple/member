					...
					<div class="box">
						<div class="tab_content">
							...
							<div class="conbox con1">
								<div style="height: 200px; text-align: center; padding: 100px 0px;" >
									<h1 class="h_font loginTitle">아이디/ 비밀번호 찾기</h1>
								</div>
								<div>
									<input type="button" value="아이디 찾기" id="submitBtn"
										class="btn submitBtn m_font">
								</div>
								<div>
									<input type="button" value="비밀번호 찾기" id="signUpBtn"
