...
public class MemberController {
	...
	// - 의뢰인 내 펫 관리
	/*
	 * @RequestMapping(value = "/member/memberMyPet") public String
	 * membermemberMyPet() { return "member/memberMyPet"; }
	 */
	 ...
	 * 의뢰인 내 펫 등록(추가) 페이지
	 * 
	 * @RequestMapping(value = "/member/memberMyPetInsert") public String
	 * memberMyPetInsert() { return "member/memberMyPetInsert"; }
	 */
